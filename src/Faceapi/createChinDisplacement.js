...
const createChinDisplacement = (
  ...
  const spriteFull = PIXI.Sprite.from(resources['chinfull3'].texture);
  ...
  spriteFull.width = (jawline[15].x - jawline[1].x) * 1.2;
  spriteFull.height = (jawline[15].x - jawline[1].x) * 1.2;

  return { filter, filterR, filterFull, sprite, spriteR, spriteFull };
};

export default createChinDisplacement;
