    ...
    img.onload = () => {
      ...
      setTimeout(() => {
        ...
        function drawMaskLoop() {
          ...
          positions[26] = [positions[26][0], positions[26][1] - 7];
          positions[66] = [positions[66][0] + 3, positions[66][1] - 3];
          positions[65] = [positions[65][0] - 5, positions[65][1] - 3];
          positions[25] = [positions[25][0] + 5, positions[25][1]];
          positions[64] = [positions[64][0] - 3, positions[64][1] + 3];
          positions[24] = [positions[24][0], positions[24][1] + 3];
          positions[63] = [positions[63][0] + 4, positions[63][1] + 3];
          ...
          // chin
          positions[2] = [positions[2][0] - 10, positions[2][1] + 3];
